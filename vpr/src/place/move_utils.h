...
enum class e_move_type {
    ...
    CRIT_UNIFORM,
    FEASIBLE_REGION,
    LAYER_SWAP_RANGED, // This is a ranged layer swap move generator
    LAYER_SWAP,
    CRIT_LAYER, // This is a critical layer move generator
    CENTROID_PROB,
    W_CENTROID_PROB,
    MEDIAN_PROB,
    CENTROID_LAYER_STUCK,
    W_CENTROID_LAYER_STUCK,
    MEDIAN_LAYER_STUCK,
    UNIFORM_LAYER_STUCK,
    TWO_OPT,
    W_MEDIAN_PROB,
    W_MEDIAN_LAYER_STUCK,
