#ifndef VPR_MEDIAN_PROB_MOVE_GEN_PROB_H
#define VPR_MEDIAN_PROB_MOVE_GEN_PROB_H
 ...
 * around it
 */
class MedianProbMoveGenerator : public MoveGenerator {
  public:
    MedianProbMoveGenerator() = delete;
    MedianProbMoveGenerator(PlacerState& placer_state,
