...
MedianLayerStuckMoveGenerator::MedianLayerStuckMoveGenerator(PlacerState& placer_state,
                                         e_reward_function reward_function,
                                         vtr::RngContainer& rng)
    : MoveGenerator(placer_state, reward_function, rng) {}

e_create_move MedianLayerStuckMoveGenerator::propose_move(t_pl_blocks_to_be_moved& blocks_affected,
    ...
    median_point.layer = from_layer; // layer stuck
...
void MedianLayerStuckMoveGenerator::get_bb_from_scratch_excluding_block(ClusterNetId net_id,
                                                              t_bb& bb_coord_new,
...
bool MedianLayerStuckMoveGenerator::get_bb_incrementally(ClusterNetId net_id,
                                               t_bb& bb_coord_new,
