#ifndef VPR_CENTROID_MOVE_GEN_LAYER_STUCK_H
#define VPR_CENTROID_MOVE_GEN_LAYER_STUCK_H
 ...
 */
class CentroidLayerStuckMoveGenerator : public MoveGenerator {
  public:
    /**
     ...
     * of the RL agent.
     */
    CentroidLayerStuckMoveGenerator(PlacerState& placer_state,
