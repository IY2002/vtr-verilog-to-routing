#ifndef VPR_CENTROID_MOVE_GEN_PROB_H
#define VPR_CENTROID_MOVE_GEN_PROB_H
 ...
 */
class CentroidProbMoveGenerator : public MoveGenerator {
  public:
    /**
     ...
     * of the RL agent.
     */
    CentroidProbMoveGenerator(PlacerState& placer_state,
