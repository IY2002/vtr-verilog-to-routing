...
WeightedMedianLayerStuckMoveGenerator::WeightedMedianLayerStuckMoveGenerator(PlacerState& placer_state,
                                                         e_reward_function reward_function,
                                                         vtr::RngContainer& rng)
    : MoveGenerator(placer_state, reward_function, rng) {}

e_create_move WeightedMedianLayerStuckMoveGenerator::propose_move(t_pl_blocks_to_be_moved& blocks_affected,
...
bool WeightedMedianLayerStuckMoveGenerator::get_bb_cost_for_net_excluding_block(ClusterNetId net_id,
