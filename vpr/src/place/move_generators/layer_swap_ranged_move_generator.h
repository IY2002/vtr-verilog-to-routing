#ifndef VPR_LAYER_SWAP_RANGED_MOVE_GENERATOR_H
#define VPR_LAYER_SWAP_RANGED_MOVE_GENERATOR_H
 ...
 */
class LayerSwapRangedMoveGenerator : public MoveGenerator {
  public:
    LayerSwapRangedMoveGenerator() = delete;
    explicit LayerSwapRangedMoveGenerator(PlacerState& placer_state,
