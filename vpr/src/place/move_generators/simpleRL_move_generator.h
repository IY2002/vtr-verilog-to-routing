...
#include "layer_swap_move_generator.h"
...
#include "median_move_generator_probabilistic.h"
#include "centroid_move_generator_no_layer_change.h"
#include "weighted_centroid_move_generator_no_layer_change.h"
#include "median_move_generator_no_layer_change.h"
#include "uniform_move_generator_no_layer_change.h"
#include "two_opt_move_generator.h"
#include "weighted_median_move_generator_probabilistic.h"
#include "weighted_median_move_generator_no_layer_change.h"
...
class KArmedBanditAgent {
  ...
  protected:
    ...
    const vtr::vector<e_move_type, double> time_elapsed_{
      1.0, // Uniform
      3.6, // Meidan
      5.4, // Centroid
      2.5, // W Centroid
      ...
      0.8, // Crit Uniform
      2.2, // Feasible Region
      1.0, // Layer Swap Ranged
      1.0, // Layer Swap
      1.0, // Crit Layer Swap
      5.4, // Centroid Prob. 
      5.4, // W Centroid Prob.
      3.6, // Median Prob.
      5.4, // Centroid Layer Stuck
      5.4, // W. Centroid Layer Stuck
      3.6, // Median Layer Stuck
      1.0, // Uniform Layer Stuck
      3.6, // Two Opt
      2.1, // W. Median Prob.
      2.1, // W. Median Layer Stuck
      5.4 // NoC Attraction Centroid
    };
...
SimpleRLMoveGenerator::SimpleRLMoveGenerator(PlacerState& placer_state,
    ...
    all_moves[e_move_type::LAYER_SWAP_RANGED] = std::make_unique<LayerSwapRangedMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::LAYER_SWAP] = std::make_unique<LayerSwapMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::CRIT_LAYER] = std::make_unique<CriticalLayerMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::CENTROID_PROB] = std::make_unique<CentroidProbMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::W_CENTROID_PROB] = std::make_unique<WeightedCentroidProbMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::MEDIAN_PROB] = std::make_unique<MedianProbMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::CENTROID_LAYER_STUCK] = std::make_unique<CentroidLayerStuckMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::W_CENTROID_LAYER_STUCK] = std::make_unique<WeightedCentroidLayerStuckMoveGenerator>(placer_state, reward_function, rng); 
    all_moves[e_move_type::MEDIAN_LAYER_STUCK] = std::make_unique<MedianLayerStuckMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::UNIFORM_LAYER_STUCK] = std::make_unique<UniformLayerStuckMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::TWO_OPT] = std::make_unique<TwoOptMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::W_MEDIAN_PROB] = std::make_unique<WeightedMedianProbMoveGenerator>(placer_state, reward_function, rng);
    all_moves[e_move_type::W_MEDIAN_LAYER_STUCK] = std::make_unique<WeightedMedianLayerStuckMoveGenerator>(placer_state, reward_function, rng);
