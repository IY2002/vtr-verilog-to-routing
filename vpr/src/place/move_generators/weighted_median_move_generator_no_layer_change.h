#ifndef VPR_WEIGHTED_MEDIAN_MOVE_GEN_LAYER_STUCK_H
#define VPR_WEIGHTED_MEDIAN_MOVE_GEN_LAYER_STUCK_H
 ...
 */
class WeightedMedianLayerStuckMoveGenerator : public MoveGenerator {
  public:
    WeightedMedianLayerStuckMoveGenerator() = delete;
    WeightedMedianLayerStuckMoveGenerator(PlacerState& placer_state,
