#ifndef VPR_WEIGHTED_MEDIAN_MOVE_GEN_PROB_H
#define VPR_WEIGHTED_MEDIAN_MOVE_GEN_PROB_H
 ...
 */
class WeightedMedianProbMoveGenerator : public MoveGenerator {
  public:
    WeightedMedianProbMoveGenerator() = delete;
    WeightedMedianProbMoveGenerator(PlacerState& placer_state,
