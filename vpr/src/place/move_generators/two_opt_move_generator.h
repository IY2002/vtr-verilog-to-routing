#ifndef VPR_TWO_OPT_MOVE_GEN_H
#define VPR_TWO_OPT_MOVE_GEN_H
 ...
 */
class TwoOptMoveGenerator : public MoveGenerator {
  public:
    TwoOptMoveGenerator() = delete;
    TwoOptMoveGenerator(PlacerState& placer_state,
