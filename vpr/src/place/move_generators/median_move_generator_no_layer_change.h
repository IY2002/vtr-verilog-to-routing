#ifndef VPR_MEDIAN_PROB_MOVE_GEN_LAYER_STUCK_H
#define VPR_MEDIAN_PROB_MOVE_GEN_LAYER_STUCK_H
 ...
 * around it
 */
class MedianLayerStuckMoveGenerator : public MoveGenerator {
  public:
    MedianLayerStuckMoveGenerator() = delete;
    MedianLayerStuckMoveGenerator(PlacerState& placer_state,
